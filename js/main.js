...
// edittask: change mistake or wrong added task
...
// savetask: to save the edited task 
let savetaskbtn = document.getElementById("savetaskbtn");
...
// deleteitem : will delete one specific task
...
// complete task: draw line through task to indicate it is done
let addedtasklist = document.getElementById("addedtasklist");
    addedtasklist.addEventListener("click", function(e){
       // console.log(e);
...
// detete all button will delete all tasks
